...
public class Camel extends PackAnimal {
    List<String> commands = Arrays.asList("есть", "спать", "бежать", "покатать на себе",
    ...
    public void sleep() {
        if (this.gender == 'f')
            System.out.println("Ваша верблюдица по имени " + this.name + "  спит");
        else
            System.out.println("Ваш верблюд по имени " + this.name + " спит");
    }

    @Override
    public void walk() {
        if (this.gender == 'f')
            System.out.println("Ваша верблюдица по имени " + this.name + " идет");
        else
            System.out.println("Ваш верблюд по имени " + this.name + " идет");
    }

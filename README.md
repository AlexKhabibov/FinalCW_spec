...
#### Решение: 
код не доделан, находиться в приложении animals_java.
Так и не мог собрать все в кучу, проблемы с реализацией, очень тяжело далась тема, как не пытался, пришлось пособирать по кусочкам отовсюду, но реализовать так и не смог к сожалению...